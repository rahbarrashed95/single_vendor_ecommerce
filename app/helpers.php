...
function getOrderStatus($type=""){
	...
	if($type != "")
    {
     return [''=> 'All', 'pending'=>'Pending','processing'=>'Processing','courier'=>'Courier','on_hold'=>'On Hold','complete'=>'Complete','cancell'=>'Cancelled','return' => 'Return']; 
    }
  
  	return ['pending'=>'Pending','processing'=>'Processing','courier'=>'Courier','on_hold'=>'On Hold','complete'=>'Complete','cancell'=>'Cancelled','return' => 'Return'];
